  ...
  return (
    <AppShell header={<PageHeader title="ملفي" />}>
      ...
      <div className="mt-4 grid grid-cols-2 gap-3">
        ...
        <Link to="/super-admin" className="surface-card flex items-center gap-3 border-amber-500/40 p-4">
          <span className="flex h-10 w-10 items-center justify-center rounded-2xl bg-amber-500/15">
            <Crown className="h-5 w-5 text-amber-400" />
          </span>
          <span className="text-sm font-bold">🏆 حدث سوبر أدمن العرب</span>
        </Link>
        <Link to="/agents" className="surface-card flex items-center gap-3 p-4">
          <span className="flex h-10 w-10 items-center justify-center rounded-2xl bg-primary/15">
            <Coins className="h-5 w-5 text-primary" />
          </span>
          <span className="text-sm font-bold">وكلاء الشحن</span>
        </Link>
        ...
        <Link to="/achievements" className="surface-card flex items-center gap-3 p-4">
          ...
          <span className="text-sm font-bold">الشارات والإنجازات</span>
        </Link>
