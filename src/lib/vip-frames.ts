...
const VIP_VISUALS: Record<number, VipVisual> = {
  1: {
    tierClass: "vip-tier-1",
    nameClass: "text-gradient-gold",
    frameClass: "animate-frame-glow",
    badgeClass: "vip-badge-1",
    entryLabel: "دخول النخبة",
  },
  2: {
    tierClass: "vip-tier-2",
    nameClass: "text-gradient-gold",
    frameClass: "animate-frame-glow",
    badgeClass: "vip-badge-2",
    entryLabel: "دخول ملكي",
  },
  3: {
    tierClass: "vip-tier-3",
    nameClass: "text-gradient-gold",
    frameClass: "animate-frame-fire",
    badgeClass: "vip-badge-3",
    entryLabel: "دخول ياقوتي",
  },
  4: {
    tierClass: "vip-tier-4",
    nameClass: "text-vip-flow",
    frameClass: "animate-frame-glow",
    badgeClass: "vip-badge-4",
    entryLabel: "دخول زمردي",
  },
  5: {
    tierClass: "vip-tier-5",
    nameClass: "text-vip-flow",
    frameClass: "animate-frame-glow",
    badgeClass: "vip-badge-5",
    entryLabel: "دخول الأسطورة",
  },
  6: {
    tierClass: "vip-tier-6",
    nameClass: "text-vip-celestial",
    frameClass: "animate-frame-celestial",
    badgeClass: "vip-badge-6",
    entryLabel: "موكب السماء",
  },
  7: {
    tierClass: "vip-tier-7",
    nameClass: "text-vip-phoenix",
    frameClass: "animate-frame-phoenix",
    badgeClass: "vip-badge-7",
    entryLabel: "موكب العنقاء",
  },
  8: {
    tierClass: "vip-tier-8",
    nameClass: "text-vip-eternal",
    frameClass: "animate-frame-eternal",
    badgeClass: "vip-badge-8",
    entryLabel: "موكب تاج الأبدية",
  },
};
